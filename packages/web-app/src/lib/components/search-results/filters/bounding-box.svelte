<script lang="ts">
  ...
  const spatialInstructions = translations?.spatialInstructions ? translations['spatialInstructions'] : '';
  const relationInstructions = translations?.relationInstructions ? translations['relationInstructions'] : '';

  const validatorRequired = translations?.validatorRequired ? translations['validatorRequired'] : 'Please fill out this field.';
  const validatorTooBig = translations?.validatorTooBig ? translations['validatorTooBig'] : 'Value must be less than or equal to ';
  const validatorTooSmall = translations?.validatorTooSmall ? translations['validatorTooSmall'] : 'Value must be greater than or equal to ';
