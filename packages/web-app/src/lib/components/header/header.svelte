...
<header
	class="sticky top-0 w-full h-20 px-5 md:px-0 border-b-4 border-custom-16 shadow-lg bg-custom-1 z-[10010]"
>
	<div class="grid grid-cols-2 h-full lg:grid-cols-6 content-width">
		...
		<div
			class="flex lg:hidden col-span-1 lg:col-span-5 justify-end text-lg font-custom-style-header-3"
		>
			<Navbarvertical />
		</div>
	</div>
