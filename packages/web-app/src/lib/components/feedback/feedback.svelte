  ...
  <div>
    {#if lang === 'fr-ca'}
      <p>
        ...
        vous intéressent.
        <br /><a class="underline hover:no-underline text-custom-16" href="mailto:geo@nrcan-rncan.gc.ca"
    ...
    {:else}
      <p>
        ...
        <br /><a class="underline hover:no-underline text-custom-16" href="mailto:geo@nrcan-rncan.gc.ca">Please send us your feedback</a>
      </p>
    {/if}
  </div>
</div>
