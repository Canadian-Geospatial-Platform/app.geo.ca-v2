<script lang="ts">
	...
	const title = lang == 'fr-ca' ? 'Nous apprécions vos commentaires' : 'We value your feedback';
</script>
...
<div class="font-custom-style-body-1 px-5 mt-9 md:px-0">
	...
	<div>
		{#if lang == 'fr-ca'}
			...
			<br />
			<p>
				Nous sommes ravis de vous accueillir à bord alors que nous explorons le passionnant monde
				...
				<a class="underline hover:no-underline text-custom-16" href="mailto:geo@nrcan-rncan.gc.ca"
