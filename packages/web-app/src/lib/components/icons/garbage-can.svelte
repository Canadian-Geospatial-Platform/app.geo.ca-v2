...
-->
<svg class={classes} viewBox="0 0 492.308 492.308" fill="currentColor" aria-hidden="true">
	<g>
		<g>
			<rect
				x="151.852"
	...
	<g>
		<g>
			<path
				stroke-width="30"
				d="M448.627,70.115h-51.173V27.577C397.454,12.375,385.089,0,369.887,0H122.416c-15.202,0-27.567,12.375-27.567,27.577
